         ...
         <form @submit.prevent="submit" class="login__form">
            ...
            <div class="login__inputs">
              <div class="login__box">
                <input type="text" v-model="fullname" placeholder="Full name" required class="login__input">
               ...
               <div class="login__box">
                <input type="password" v-model="confirmpassword" placeholder="Confirm Password" required class="login__input">
                <i class="ri-lock-2-fill"></i>
             </div>
            </div>
